Extract the output_files.zip. This contains all the images obtained as part of descriptive analytics as well as other output files. The report contains all the details of the programs. 
